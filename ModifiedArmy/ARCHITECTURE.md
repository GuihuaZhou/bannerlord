...
| 属性 | 说明 | 默认值 |
|------|------|--------|
| `baseLimit` | 定居点自身可供养的基础部队人数 | 100 |
| `villageBonus` | 每个附属村庄额外人数加成 | 10 |
| `minWeeklySupplement` | 每周最少补充人数 | 5 |
| `maxWeeklySupplement` | 每周最多补充人数 | 20 |
| **`maxServiceWeeks`** | **封邑兵最大服役周期（周）** | **5** |
| **`returnCooldownWeeks`** | **归还后冷却周期（周）** | **3** |
| **`prosperityCostPerTier`** | **征召时每名士兵每 Tier 消耗的繁荣度** | **4** |
| **`hearthCostPerTroop`** | **征召时每名士兵消耗的户数** | **1** |

### 各文化模板数值表

| 文化 | 定居点类型 | baseLimit | villageBonus | minWeekly | maxWeekly | maxServiceWeeks | returnCooldownWeeks | prosperityCostPerTier | Retinue权重 | Sergeant权重 | Marine权重 | Militia权重 |
|------|-----------|-----------|-------------|-----------|-----------|----------------|-------------------|----------------------|------------|-------------|-----------|------------|
| **Empire** | town_port | 40 | 10 | 5 | 10 | 5(默认) | 3(默认) | **5** | — | 2 | 1 | 2 |
| | town | 40 | 10 | 5 | 10 | 5(默认) | 3(默认) | **5** | — | 1 | — | 1 |
| | castle | 40 | 10 | 5 | 10 | 5(默认) | 3(默认) | **2** | 1 | 1 | — | 3 |
| **Aserai** | town_port | 50 | 10 | 5 | 10 | 5(默认) | 3(默认) | **5** | — | 2 | 1 | 2 |
| | town | 50 | 10 | 5 | 10 | 5(默认) | 3(默认) | **5** | — | 1 | — | 1 |
| | castle | 40 | 10 | 5 | 10 | 5(默认) | 3(默认) | **2** | 1 | — | — | 3 |
| **Sturgia** | town_port | 90 | 20 | 10 | 20 | 5(默认) | 3(默认) | **8** | — | 2 | 1 | 2 |
| | town | 90 | 20 | 10 | 20 | 5(默认) | 3(默认) | **8** | — | 1 | — | 1 |
| | castle | 90 | 20 | 10 | 20 | 5(默认) | 3(默认) | **3** | 1 | 1 | — | 3 |
| **Vlandia** | town_port | 120 | 30 | 10 | 30 | **7** | 3(默认) | **10** | — | 2 | 1 | 2 |
| | town | 120 | 30 | 10 | 30 | **7** | 3(默认) | **10** | — | 1 | — | 1 |
| | castle | 80 | 25 | 10 | 30 | **7** | 3(默认) | **4** | 1 | 1 | — | 3 |
| **Battania** | town_port | 80 | 30 | 10 | 20 | 5(默认) | 3(默认) | **7** | — | 2 | 1 | 2 |
| | town | 70 | 30 | 10 | 20 | 5(默认) | 3(默认) | **7** | — | 1 | — | 1 |
| | castle | 70 | 30 | 10 | 20 | 5(默认) | 3(默认) | **3** | 1 | — | — | 4 |
| **Khuzait** | town_port | 70 | 20 | 10 | 20 | 5(默认) | **1** | **8** | — | 1 | — | 4 |
| | town | 70 | 20 | 10 | 20 | 5(默认) | **1** | **8** | — | 1 | — | 4 |
| | castle | 70 | 40 | 10 | 20 | 5(默认) | **1** | **3** | 1 | 1 | — | 3 |
| **Nord** | town_port | 70 | 20 | 10 | 20 | 5(默认) | 3(默认) | **8** | 1 | 2 | — | 7 |
| | town | 70 | 20 | 10 | 20 | 5(默认) | 3(默认) | **8** | 1 | 2 | — | 7 |
| | castle | 70 | 20 | 10 | 20 | 5(默认) | 3(默认) | **3** | 1 | 2 | — | 7 |

**文化差异总结**：

| 文化 | 特色 | 服役周期 | 冷却周期 | 征召成本 | 设计意图 |
|------|------|---------|---------|---------|---------|
| **Vlandia** | 服役长(7周)、征召贵(10) | **7** | 3 | **最高** | 西欧采邑制，贵族长期效忠但要价高 |
| **Khuzait** | 冷却快(1周)、民兵占比高 | 5 | **1** | 中等 | 游牧召之即来、快速重组 |
| **Empire** | 封邑弱、征召便宜(2-5) | 5 | 3 | **最低** | 军区制，封邑弱但依赖志愿兵/雇佣兵 |
| **Aserai** | 征召便宜(2-5)、有奴隶兵 | 5 | 3 | **低** | 伊克塔灵活，依赖奴隶兵+雇佣兵 |
| **Sturgia** | 兵力上限高、中等成本 | 5 | 3 | 中等 | 亲兵精英制 |
| **Battania** | 村庄加成高、中等成本 | 5 | 3 | 中等 | 部落制依赖乡村 |
| **Nord** | 民兵占比极高、中等成本 | 5 | 3 | 中等 | 维京全民战士 |
