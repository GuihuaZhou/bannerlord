...
namespace TaleWorlds.CampaignSystem.Settlements.Buildings
{
	...
	public class DefaultBuildingTypes
	{
		...
		{
			this._buildingSettlementFortifications.Initialize(new TextObject("{=CVdK1ax1}Fortifications", null), new TextObject("{=dIM6xa2O}Better fortifications and higher walls around town, also increases the max garrison limit since it provides more space for the resident troops.", null), new int[]
			{
				0,
				6000,
				12000
			...
			this._buildingSettlementBarracks.Initialize(new TextObject("{=x2B0OjhI}Barracks", null), new TextObject("{=JalrbDBC}Lodgings for garrison troops. Each level increases garrison limit and decreases garrison wage.", null), new int[]
			{
				1800,
				3000,
				4200
			...
			this._buildingSettlementTrainingFields.Initialize(new TextObject("{=BkTiRPT4}Training Fields", null), new TextObject("{=NYzORuQm}Provides experience for garrison troops and increases militia veterancy.", null), new int[]
			{
				1500,
				2100,
				2700
			...
			this._buildingSettlementGuardHouse.Initialize(new TextObject("{=OHEiwoHC}Guard House", null), new TextObject("{=doojtAwr}Increases prisoner limit and provides a patrol party that improves security.", null), new int[]
			{
				1500,
				2100,
				2700
			...
			this._buildingSettlementSiegeWorkshop.Initialize(new TextObject("{=9Bnwttn6}Siege Workshop", null), new TextObject("{=MharAceZ}Builds and maintains siege engines for defense of the settlement.", null), new int[]
			{
				1200,
				1800,
				3000
			...
			this._buildingSettlementTaxOffice.Initialize(new TextObject("{=LG84byW0}Tax Office", null), new TextObject("{=nQ6ytZeF}Increases tax income.", null), new int[]
			{
				1800,
				3000,
				4200
			...
			this._buildingSettlementMarketplace.Initialize(new TextObject("{=zLdXCpne}Marketplace", null), new TextObject("{=Z0xf3Bbd}Increases the tariff collected from trades made in town", null), new int[]
			{
				2400,
				3600,
				4800
			...
			this._buildingSettlementWarehouse.Initialize(new TextObject("{=anTRftmb}Warehouse", null), new TextObject("{=hhKDZJeM}Increases Food storage limits and improves workshop productivity.", null), new int[]
			{
				1800,
				2400,
				3000
			...
			this._buildingSettlementMason.Initialize(new TextObject("{=R7ssoDHW}Mason", null), new TextObject("{=hqUPvnaj}Increase bricks per day, increasing building and repair speed.", null), new int[]
			{
				2400,
				3000,
				4800
			...
			this._buildingSettlementWaterworks.Initialize(new TextObject("{=DA0y7B3S}Waterworks", null), new TextObject("{=SfbwSASh}Waterways and sanitation, decrease food consumption.", null), new int[]
			{
				1800,
				3600,
				5400
			...
			this._buildingSettlementCourthouse.Initialize(new TextObject("{=Bw8kAvGY}Courthouse", null), new TextObject("{=tmLJvPlz}Local judges manage disputes and maintain law and order. Provides influence and loyalty per day.", null), new int[]
			{
				2400,
				3600,
				5400
			...
			this._buildingSettlementRoadsAndPaths.Initialize(new TextObject("{=maEmutDP}Roads and Paths", null), new TextObject("{=YPFDiwuy}Increase village production and village hearth growth.", null), new int[]
			{
				2400,
				3600,
				4800
			...
			this._buildingCastleFortifications.Initialize(new TextObject("{=CVdK1ax1}Fortifications", null), new TextObject("{=oS5Nesmi}Better fortifications and higher walls around the keep, also increases the max garrison limit since it provides more space for the resident troops.", null), new int[]
			{
				0,
				1400,
				2800
			...
			this._buildingCastleBarracks.Initialize(new TextObject("{=x2B0OjhI}Barracks", null), new TextObject("{=JalrbDBC}Lodgings for garrison troops. Each level increases garrison limit and decreases garrison wage.", null), new int[]
			{
				420,
				700,
				1120
			...
			this._buildingCastleGuardHouse.Initialize(new TextObject("{=OHEiwoHC}Guard House", null), new TextObject("{=K0cbj7o3}Increase militia recruitment, and prisoner limit.", null), new int[]
			{
				350,
				490,
				630
			...
			this._buildingCastleSiegeWorkshop.Initialize(new TextObject("{=9Bnwttn6}Siege Workshop", null), new TextObject("{=YRCW0oFd}Builds and maintains siege engines for defense of the settlement.", null), new int[]
			{
				280,
				420,
				700
			...
			this._buildingCastleCastallansOffice.Initialize(new TextObject("{=kLNnFMR9}Castellan's Office", null), new TextObject("{=GDsI6daq}Increases auto recruitment, and decreases garrison wage.", null), new int[]
			{
				560,
				840,
				1260
			...
			this._buildingCastleGranary.Initialize(new TextObject("{=PstO2f5I}Granary", null), new TextObject("{=iazij7fO}Increases food storage limits.", null), new int[]
			{
				420,
				560,
				700
			...
			this._buildingCastleCraftmansQuarters.Initialize(new TextObject("{=KE1KUayw}Craftmans Quarters", null), new TextObject("{=2qZ14G9p}Provides income based on bound village hearts", null), new int[]
			{
				350,
				490,
				630
			...
			this._buildingCastleFarmlands.Initialize(new TextObject("{=l4eZqegY}Farmlands", null), new TextObject("{=tajCl8Bg}Provides daily food.", null), new int[]
			{
				420,
				630,
				840
			...
			this._buildingCastleMason.Initialize(new TextObject("{=R7ssoDHW}Mason", null), new TextObject("{=hqUPvnaj}Increase bricks per day, increasing building and repair speed.", null), new int[]
			{
				560,
				700,
				1120
			...
			this._buildingCastleRoadsAndPaths.Initialize(new TextObject("{=maEmutDP}Roads and Paths", null), new TextObject("{=YPFDiwuy}Increase village production and village hearth growth.", null), new int[]
			{
				560,
				840,
				1120
