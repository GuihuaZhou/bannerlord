...
namespace TaleWorlds.CampaignSystem.CampaignBehaviors
{
	...
	{
		// Token: 0x06003CE8 RID: 15592 RVA: 0x00105838 File Offset: 0x00103A38
		...
		// Token: 0x06003CE9 RID: 15593 RVA: 0x00105944 File Offset: 0x00103B44
		...
		// Token: 0x06003CEA RID: 15594 RVA: 0x001059A0 File Offset: 0x00103BA0
		...
		// Token: 0x06003CEB RID: 15595 RVA: 0x001059EC File Offset: 0x00103BEC
		public override void SyncData(IDataStore dataStore)
		{
		}

		// Token: 0x06003CEC RID: 15596 RVA: 0x001059F0 File Offset: 0x00103BF0
		...
		// Token: 0x06003CED RID: 15597 RVA: 0x00105B84 File Offset: 0x00103D84
		...
		// Token: 0x06003CEE RID: 15598 RVA: 0x00105C24 File Offset: 0x00103E24
		...
		// Token: 0x06003CEF RID: 15599 RVA: 0x00105C44 File Offset: 0x00103E44
		...
		// Token: 0x06003CF0 RID: 15600 RVA: 0x00105F48 File Offset: 0x00104148
		...
		// Token: 0x06003CF1 RID: 15601 RVA: 0x001060B4 File Offset: 0x001042B4
		...
		// Token: 0x06003CF2 RID: 15602 RVA: 0x00106320 File Offset: 0x00104520
		...
		// Token: 0x06003CF3 RID: 15603 RVA: 0x001064E0 File Offset: 0x001046E0
		private void OnGameLoadFinished()
		{
			foreach (Kingdom kingdom3 in Kingdom.All)
			{
				kingdom3.CalculateMidSettlement();
			}
			foreach (Clan clan in Clan.All)
			{
				clan.CalculateMidSettlement();
			...
			if (MBSaveLoad.IsUpdatingGameVersion && MBSaveLoad.LastLoadedGameVersion.IsOlderThan(ApplicationVersion.FromString("v1.3.14", 0)))
			{
				for (int j = Kingdom.All.Count - 1; j >= 0; j--)
				{
					Kingdom kingdom = Kingdom.All[j];
					if (!kingdom.IsEliminated)
					{
						using (List<Kingdom>.Enumerator enumerator = (from t in Kingdom.All
						where t != kingdom && t.RulingClan == kingdom.RulingClan
						select t).ToList<Kingdom>().GetEnumerator())
						{
							while (enumerator.MoveNext())
							{
								Kingdom sameRulerKingdom = enumerator.Current;
								if (sameRulerKingdom.Clans.Count > 1)
								{
									Clan clan2 = (from t in sameRulerKingdom.Clans
									where t != sameRulerKingdom.RulingClan
									orderby t.CurrentTotalStrength descending
									select t).First<Clan>();
									ChangeRulingClanAction.Apply(sameRulerKingdom, clan2);
								}
								else
								{
		...
		// Token: 0x06003CF4 RID: 15604 RVA: 0x00106754 File Offset: 0x00104954
		...
		// Token: 0x06003CF5 RID: 15605 RVA: 0x0010691C File Offset: 0x00104B1C
		...
		// Token: 0x06003CF6 RID: 15606 RVA: 0x00106BF8 File Offset: 0x00104DF8
		...
		// Token: 0x06003CF7 RID: 15607 RVA: 0x00106C98 File Offset: 0x00104E98
		...
		// Token: 0x06003CF8 RID: 15608 RVA: 0x00106DAC File Offset: 0x00104FAC
		...
		// Token: 0x06003CF9 RID: 15609 RVA: 0x00106DF0 File Offset: 0x00104FF0
